...
export function Citadel(props) {
  ...
  return (
    ...
    >
      ...
      />
      <CuboidCollider args={[5, 2.5, 7]} position={[-2.5, -11.1, 12]}/>
      ...
      <CuboidCollider args={[1, 0.5, 1]} position={[1.5, -9.8, 10]} rotation={[0,0,0]}/>
      ...
      <CuboidCollider args={[1.7, 4, 5.2]} position={[0.8, -6.7, 14.2]} rotation={[0,-Math.PI/1,0]}/> 
